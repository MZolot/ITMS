...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_profile_default = QtWidgets.QAction(MainWindow)
        self.action_profile_default.setObjectName("action_profile_default")
        ...
        self.action_draw_static_profile = QtWidgets.QAction(MainWindow)
        self.action_draw_static_profile.setEnabled(False)
        self.action_draw_static_profile.setObjectName("action_draw_static_profile")
        self.action_select_marigram_points = QtWidgets.QAction(MainWindow)
        self.action_select_marigram_points.setObjectName("action_select_marigram_points")
        self.action_profile_koryto = QtWidgets.QAction(MainWindow)
        self.action_profile_koryto.setObjectName("action_profile_koryto")
        self.action_profile_flat = QtWidgets.QAction(MainWindow)
        self.action_profile_flat.setObjectName("action_profile_flat")
        self.action_profile_tilted = QtWidgets.QAction(MainWindow)
        self.action_profile_tilted.setObjectName("action_profile_tilted")
        self.menu_bottom_profile.addAction(self.action_profile_default)
        self.menu_bottom_profile.addAction(self.action_profile_koryto)
        self.menu_bottom_profile.addAction(self.action_profile_flat)
        self.menu_bottom_profile.addAction(self.action_profile_tilted)
        ...
        self.menu_source.addAction(self.action_draw_static_profile)
        self.menu_marigrams.addAction(self.action_select_marigram_points)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_wave_profile_bar_chart.setText(_translate("MainWindow", "Coastal wave profile"))
        ...
        self.action_profile_default.setText(_translate("MainWindow", "Default"))
        ...
        self.action_draw_static_profile.setText(_translate("MainWindow", "Draw STATIC profile"))
        self.action_select_marigram_points.setText(_translate("MainWindow", "Select points"))
        self.action_profile_koryto.setText(_translate("MainWindow", "Koryto"))
        self.action_profile_flat.setText(_translate("MainWindow", "Flat..."))
        self.action_profile_tilted.setText(_translate("MainWindow", "Tilted..."))

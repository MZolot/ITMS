...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.push_button_new_profile = QtWidgets.QPushButton(self.buttons_widget)
        self.push_button_new_profile.setMinimumSize(QtCore.QSize(95, 28))
        self.push_button_new_profile.setMaximumSize(QtCore.QSize(95, 28))
        self.push_button_new_profile.setObjectName("push_button_new_profile")
        self.buttons_layout.addWidget(self.push_button_new_profile)
